...
Do przesukiwania i~modyfikowania danych przechowywanych w~bazie danych Cassandra służy język CQL (Cassandra Query Language).
Jest on podobny do języka SQL, jednak 
