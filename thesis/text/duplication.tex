...
\begin{itemize}
 ...
 \item SQLMetal~\cite{sqlmetal} - narzędzie dla platformy .Net, którego jedynym zadaniem jest generacja kodu źródłowego klas na podstawie struktury bazy danych;
