...
Żaden z~przedstawionych wcześniej sposobów opisu dziedziny nie mógł być pokazany w~całości na jednej stronie, podczas gdy powyższy opis mieści się na jednej stronie mimo zawarcia w~nim pustych linii i~słów w~języku naturalnym.
