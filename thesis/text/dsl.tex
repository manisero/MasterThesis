...
Wynik działania tego algorytmu będzie jednak taki sam jak algorytmu przestawionego w~poprzednim rozdziale, więc pozostałe elementy generatora (szablony generacji, organizcja plików wynikowych) nie będą wymagać zmian.
