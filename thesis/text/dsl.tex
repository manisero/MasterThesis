...
Scenariusze testowe mogą być oparte bezpośrednio na definicjach zdarzeń i~widoków zawartych w~opisie dziedziny aplikacji.
...
\begin{itemize}
 \item Algorytm wyodrębnienia jednostek generacji z~opisu dziedziny wyodrębnieniałby opisy scenariuszy testowych jako osobne jednostki generacji, 
 \item a~odpowiedni szablon generowałby na ich podstawie właściwe scenariusze.
 \item SpecFlow
\end{itemize}
