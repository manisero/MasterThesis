...
Należy jednak zaznaczyć, że ten sposób opisu dziedziny aplikacji nie jest tak uniwersalny jak schemat przedstawiony w~sekcji~\ref{sec:domain_schema_definition}.

Ogólny schemat postępowania podczas konstruowania generatora aplikacji z~wykorzystaniem DSL jest następujący:

\begin{enumerate}
 \item Sformułowanie wymagań funkcjonalnych aplikacji.
