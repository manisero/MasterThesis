    ...
    \begin{itemize}
     \item zalety:
      \begin{itemize}
       ...
       \item nie trzeba czytać dziedziny, tylko jednostki generacji (aktualną dziedzinę i tak trzeba czytać)
     ...
     \item wady:
      \begin{itemize}
       ...
       \item na podstawie snapshota nie da się łatwo odtworzyć dziedziny
      \end{itemize}
    \end{itemize}
