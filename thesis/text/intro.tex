...
W~rozdziale 3 (``Założenia dotyczące rdzenia narzędzia'')

Rozdział 4 (``Sprecyzowanie typu generowanych aplikacji'')

Rozdział 5 (``Implementacja generatora'')

Rozdział 6 (``Wykorzystanie DSL'')

Rozdział 7 (``Podsumowanie'') stanowi podsumowanie pracy.
