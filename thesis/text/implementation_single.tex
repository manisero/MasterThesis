...
\begin{itemize}
 \item wyświetlania danego bloga, tzn. wszystkich wpisów jego autora - w~tym celu wykonane zostanie pojedyncze odwołanie do widoku $Post$;
...
Że UserPost rozbito
Na uwagę zasługuje pole CommentsNumber widoku Post.



%=======
\section{Generowane artefakty}
%=======
