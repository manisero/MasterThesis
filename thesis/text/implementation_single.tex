...
Jako ze CQL dobrze mapuje sie na C\# (wiele CQL na jeden C\#, ale nie odwrotnie), w tym przypadku wystarczy CQL
gdyby było inaczej (w innych bazach danych, w innych językach, w innych rodzajach aplikacji), to własne lub 2 pola)

Dlatego w~dotychczas prezentowanych przykładach wszystkie pola encji, widoków i~zdarzeń posiadały typ $text$.
Jest to typ danych języka CQL oznaczający ciąg znaków.

że będzie potrzebna TypesMap.GetDotNetType
