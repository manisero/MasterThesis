...
Aby dostosować zachowanie generatora do potrzeb aplikacji, należy:

\begin{itemize}
 \item tak aby korzystał on z~bardziej zaawansowanych mechanizmów bazy Cassandra niż proste definicje rodzin kolumn i~indeksów - szablony generacji
 \item aplikacji o klasycznej architekturze trójwarstwowej, korzystającej z~bazy danych SQL - algorytm wyodrębnienia jednostek generacji i szablony
\end{itemize}
