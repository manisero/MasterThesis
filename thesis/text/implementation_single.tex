...
Programistom pozostaje jedynie zaimplementowanie tych części systemu, które albo implementuje się raz (są generyczne), albo zawierają logikę biznesową, którą trudno zawrzeć w~opisie dziedziny systemu.
