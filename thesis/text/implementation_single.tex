...
Najbardziej naiwnym sposobem opisu dziedziny jest jawne wypisanie wszystkich elementów, które powinny znaleźć się w~systemie.

\ref{fig:single:model_verbose}
...
Dlatego wydaje się, że najlepszym i~najbardziej naturalnym sposobem opisu dziedziny aplikacji jest opisanie jedynie widków i~użycie tego opisu jako podstawy do wygenerowania wszystkich artefaktów.
